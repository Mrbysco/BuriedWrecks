...
public class BuriedShipwreckPieces {
	...
	private static final ResourceLocation[] STRUCTURE_LOCATION_BEACHED = new ResourceLocation[]{
			...
			BuriedWrecks.modLoc("buried_shipwreck/sideways_backhalf"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_full"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_fronthalf"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_backhalf"),
			BuriedWrecks.modLoc("buried_shipwreck/with_mast_degraded"),
	...
	private static final ResourceLocation[] STRUCTURE_LOCATION_OCEAN = new ResourceLocation[]{
			...
			BuriedWrecks.modLoc("buried_shipwreck/upsidedown_backhalf"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_full"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_fronthalf"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_backhalf"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_full"),
			...
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_backhalf"),
			BuriedWrecks.modLoc("buried_shipwreck/with_mast_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/upsidedown_full_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/upsidedown_fronthalf_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/upsidedown_backhalf_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_full_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_fronthalf_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/sideways_backhalf_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_full_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_fronthalf_degraded"),
			BuriedWrecks.modLoc("buried_shipwreck/rightsideup_backhalf_degraded")};
