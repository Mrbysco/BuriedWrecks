...
public class BuriedShipwreckPieces {
	...
	private static final Identifier[] STRUCTURE_LOCATION_BEACHED = new Identifier[]{
			Constants.modLoc("buried_shipwreck/with_mast"),
			Constants.modLoc("buried_shipwreck/sideways_full"),
			Constants.modLoc("buried_shipwreck/sideways_fronthalf"),
			Constants.modLoc("buried_shipwreck/sideways_backhalf"),
			Constants.modLoc("buried_shipwreck/rightsideup_full"),
			Constants.modLoc("buried_shipwreck/rightsideup_fronthalf"),
			Constants.modLoc("buried_shipwreck/rightsideup_backhalf"),
			Constants.modLoc("buried_shipwreck/with_mast_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_full_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_fronthalf_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_backhalf_degraded")};
	private static final Identifier[] STRUCTURE_LOCATION_OCEAN = new Identifier[]{
			Constants.modLoc("buried_shipwreck/with_mast"),
			Constants.modLoc("buried_shipwreck/upsidedown_full"),
			Constants.modLoc("buried_shipwreck/upsidedown_fronthalf"),
			Constants.modLoc("buried_shipwreck/upsidedown_backhalf"),
			Constants.modLoc("buried_shipwreck/sideways_full"),
			Constants.modLoc("buried_shipwreck/sideways_fronthalf"),
			Constants.modLoc("buried_shipwreck/sideways_backhalf"),
			Constants.modLoc("buried_shipwreck/rightsideup_full"),
			...
			Constants.modLoc("buried_shipwreck/rightsideup_backhalf"),
			Constants.modLoc("buried_shipwreck/with_mast_degraded"),
			Constants.modLoc("buried_shipwreck/upsidedown_full_degraded"),
			Constants.modLoc("buried_shipwreck/upsidedown_fronthalf_degraded"),
			Constants.modLoc("buried_shipwreck/upsidedown_backhalf_degraded"),
			Constants.modLoc("buried_shipwreck/sideways_full_degraded"),
			Constants.modLoc("buried_shipwreck/sideways_fronthalf_degraded"),
			Constants.modLoc("buried_shipwreck/sideways_backhalf_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_full_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_fronthalf_degraded"),
			Constants.modLoc("buried_shipwreck/rightsideup_backhalf_degraded")};
