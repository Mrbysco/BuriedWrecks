...
public class BuriedWreckFeature extends Structure {
	...
	public BuriedWreckFeature(StructureSettings structureSettings, boolean beached, int yLevel) {
	...
	private void generatePieces(StructurePiecesBuilder piecesBuilder, GenerationContext generationContext) {
